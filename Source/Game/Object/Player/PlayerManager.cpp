...
void PlayerManager::Initialize()
{
    ...
    Player* player1 = new Player("Data/Fbx/Player_02/Player_02.model", false, { 5.0f,0.0f,0.0f,1.0f });
    player1->SetPos({ 0,0,0 });
    player1->SetColor({ 1.0f,0.0f,0.0f,1.0f });
    Register(player1);

    Player* player2 = new Player("Data/Fbx/Player_02/Player_02.model", true, { 0.0f,0.0f,5.0f,1.0f });
