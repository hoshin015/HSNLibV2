...
void AudioManager::Initialize()
{
	...
	LoadMusic(static_cast<int>(MUSIC_LABEL::GAME_WNID), L"Data/Audio/GAME_WIND.wav");
	LoadMusic(static_cast<int>(MUSIC_LABEL::GAME_MAIN), L"Data/Audio/GAME_MAIN.wav");
	LoadMusic(static_cast<int>(MUSIC_LABEL::GAME_CLEAR), L"Data/Audio/GAME_CLEAR.wav");
